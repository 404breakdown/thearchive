...
<body>
    ...
    <div class="content-wrapper">
        <div class="top-nav d-flex justify-content-between align-items-center flex-wrap">
            <h3 class="mb-0"><i class="bi bi-archive"></i> Archive</h3>
                        ...
                        <div class="row">
                            <?php foreach ($user_folders as $user): ?>
                                <div class="col-md-6 col-lg-4 mb-3">
                                    <div class="card user-card" onclick="window.location.href='archive_view.php?user=<?php echo urlencode($user['folder']); ?>'">
                                        <div class="card-body">
